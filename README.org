...
- *Pure declarative approach* — uses =invisible=, =cursor-intangible=, and =read-only= text properties
...
- *=invisible= text property*: Hides/de-emphasizes text outside region
...
*Text not hiding as expected:*
- Ensure =buffer-invisibility-spec= includes ='soft-narrow=
